...
![The geographic range of work for the 20mm Survey. Each point represents the location of a sampling station, totaling to 52 stations of primary interest. Stations are colored according to their relationship with the 20mm index calculation, where blue represents stations that have been included since the inception of the survey (1995), green represents stations that were added in 2008 and have been precluded from the calculation, and red represents high outflow stations that are not included in the calculation.  ](20mmMap.png){width=600px}
