...
```{r, overall map, echo = F, results='asis', fig.cap="Figure 1. Map of all SLS sampling stations. Each blue point represents the location of a station by the survey. The map is interactive. Hover over the markers to show the station label."}
...
specialStations <- data.frame(Station = as.character(c(716, 809, 812, 815, 901, 902, 906, 910, 912, 914, 915, 918, 919)),
...
3. when longfin smelt are no longer found in the central or south Delta (Stations? Label on) in high densities in danger of being entrained at the Central Valley Project (CVP) and State Water Project (SWP)
